...
$workspaceManifest = [ordered]@{
    ...
    dependencies=[ordered]@{
        ports=@{version='0.8.1';url='https://github.com/brant92good/port-forward-tui/releases/download/v0.8.1/ports-x86_64-pc-windows-msvc.zip';sha256=$PortsSha256;binary_sha256=$workspaceHashes['bin/ports.exe']}
